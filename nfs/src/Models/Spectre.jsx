      ...
      <section>
        <div className="container">
          ...
          <div className="container">
            ...
            <h2>Overview</h2>
            <p>
              The Rolls-Royce Spectre is a full-sized luxury electric car
              manufactured by Rolls-Royce Motor Cars. The first deliveries of
              the car were made in the last quarter of 2023. It is Rolls-Royce's
              first electric vehicle (EV) and rides on the same platform as the
              Phantom and Cullinan. The new Rolls-Royce coupe model: the
              Spectre. It’s priced and positioned between the Cullinan SUV and
              the Phantom flagship in the Rolls-Royce hierarchy, but this is
              much more than a niche-filler – it’s a sign of things to come for
              the double-R brand. By the end of the decade, every single
              Rolls-Royce will be fully electric.
            </p>
            <p>
              The Spectre is the first battery-powered model to carry the Spirit
              of Ecstasy on the prow of its bonnet. Don’t mistake the Spectre as
              being an ‘eco-Rolls’. It isn’t swathed in vegan pleather or
              sustainably-sourced hemp. This is a huge monument to conspicuous
              consumption, and you could argue it’s actually rather vulgar.
              Sure, the cells in the battery are produced using ‘green
              electricity’, says Rolls, and there’s a commitment to only use
              responsibly-sourced rare earth metals in the batteries, but
              compared to the likes of a Polestar 2 for example, this isn’t a
              car which you’ll buy because it’s got an eye on lifetime CO2
              emissions.
            </p>
            <p>
              You’ll buy it because it’s a Rolls-Royce, first and foremost.
              You’ll buy it because it may very well be the finest motor car in
              the world. The Spectre is a truly immense coupe. That glinting
              grille is lower and wider than a Phantom’s Parthenon-esque façade,
              and the corners of its bonnet taper gently downwards instead of
              standing as upright as a bearskin-topped guardsman, but these nods
              to slippery aerodynamics don’t diminish the gravitational presence
              this mighty two-door generates.
            </p>
            <h2>Price and Availability</h2>
            <p>
              The Rolls-Royce Spectre is priced at Rs. 7.50 crore (ex-showroom
              Delhi). Deliveries began in the last quarter of 2023.
            </p>
            <h2>Conclusion</h2>
            <p>
              The Rolls-Royce Spectre sets a new standard for luxury electric
              vehicles. With its cutting-edge technology, elegant design, and
              unparalleled comfort, it embodies the essence of Rolls-Royce

        ...
        <>
            ...
            <section class="banner">
                <div class="container-fluid">
                    <img src={RollsRoyce_banner} alt="Rolls-Royce Banner" width="1500px" />
                </div>
            </section>
            <br></br>
            {/*--------------------     Header section    --------------------- */}
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-md-6 col-sm-12">
                            ...
                            <p class="header__description">
                                Purveyors of probably the most luxurious cars on the planet. Rolls-Royce offers vast, lavish, impossibly
                                comfortable land yachts to the sort of customers who light their Cuban cigars with £50 notes. Now owned by
                                BMW, but retaining an ethos as British as cucumber sandwiches. If you like your cars compact and
                                unobtrusive, you need not apply. If you don’t already own at least a couple of yachts and a helicopter, you
                                need not apply.
                            </p>
                        </div>
                        <div class="col-xl-3 col-md-3 col-sm-16">
                            <img src={RollsRoyce_logo} alt="RollsRoyce Logo" class="header__logo" />
                        </div>
                        <div class="col-xl-3 col-md-3 col-sm-16">
                            <div class="Company__description">
                                <ul class="bugatti-list">
                                    <li>Founded: March 1998; 26 years ago in the United Kingdom</li>
                                    <li>Parent: BMW</li>
                                    <li>Headquarters: Goodwood, West Sussex, England, United Kingdom</li>
                                    <li>
                                        Key people:
                                        <ul>
                            ...
                            <div className="row">
                                <div className="col-md-6 col-sm-12">
                                    ...
                                    <div className="about__img-container">
                                        <img src={RollsRoyce_cullinan_img} alt="Rolls-Royce Cullinan" className="model__img" />
                                ...
                                <div className="col-md-6 col-sm-12">
                                    ...
                                    <div className="about__data">
                                        <p className="about__description">
                                            The Rolls-Royce Cullinan is a luxury SUV that epitomizes opulence and off-road capability.
                                            Powered by a 6.75-liter V12 engine with 563 horsepower, it delivers a smooth and powerful ride
                                            on any terrain. The Cullinan's interior is a sanctuary of comfort, with plush seating, high-end
                                            materials, and customizable features. With its commanding presence and advanced technology, the
                                            Cullinan redefines luxury in the SUV segment, offering an unparalleled driving experience both
                                            on and off the road.
                                        </p>
                        ...
                        <form>
                            <div className="row">
                                <div className="col-md-6 col-sm-12">
                                    ...
                                    <br />
                                    <div className="about__img-container">
                                        <img src={RollsRoyce_spectre_img} alt="Rolls-Royce Spectre" className="model__img" />
                                        <div className="text-overlay-sub">
                                            <h2>9/10</h2>
                                        </div>
                                    </div>
                                ...
                                <div className="col-md-6 col-sm-12">
                                    ...
                                    <div className="about__data">
                                        <p className="about__description">
                                            The new Rolls-Royce coupe model: the Spectre. It’s priced and positioned between the Cullinan
                                            SUV and the Phantom flagship in the Rolls-Royce hierarchy, but this is much more than a
                                            niche-filler – it’s a sign of things to come for the double-R brand. By the end of the decade,
                                            every single Rolls-Royce will be fully electric. The Spectre is the first battery-powered model
                                            to carry the Spirit of Ecstasy on the prow of its bonnet.
                                        </p>
                        ...
                        <form>
                            <div className="row">
                                <div className="col-md-6 col-sm-12">
                                    ...
                                    <br />
                                    <div className="about__img-container">
                                        <img src={RollsRoyce_ghost_img} alt="Rolls-Royce Ghost" className="model__img" />
                                        <div className="text-overlay-sub">
                                            <h2>9/10</h2>
                                        </div>
                                    </div>
                                ...
                                <div className="col-md-6 col-sm-12">
                                    ...
                                    <div className="about__data">
                                        <p className="about__description">
                                            The Rolls-Royce Ghost is a luxury sedan that combines elegance with modern technology. Powered
                                            by a 6.75-liter V12 engine, it offers a smooth, effortless drive with 563 horsepower. The
                                            Ghost's interior is a masterpiece of craftsmanship, featuring the finest materials and bespoke
                                            options like the Starlight headliner. Its design is understated yet refined, making it an ideal
                                            choice for those who seek both luxury and performance in a more dynamic, driver-focused
                                            Rolls-Royce.
                                        </p>

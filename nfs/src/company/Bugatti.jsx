          ...
          <div class="row">
            <div class="col-xl-6 col-md-6 col-sm-12">
              ...
              <p class="header__description">
                French maker of cheap and cheerful city runab—nah just kidding,
                it’s Bugatti. Creator of the Veyron and the Chiron, this
                aristocratic branch of the Volkswagen Group can justifiably
                claim to build the fastest cars in the world. If you want to
                experience the awesome power of a Bugatti, you’ll need (a) a
                decent Euromillions win and (b) a very large and empty airfield
                to get anywhere near the limits of its performance.
              </p>
            </div>
                ...
                <div className="col-md-6 col-sm-12">
                  ...
                  <div className="about__data">
                    <p className="about__description">
                      The tourbillon stands as a pinnacle of horological
                      mastery, embodying a perfect blend of precision,
                      craftsmanship, and elegance. Featuring a complex mechanism
                      that counters the effects of gravity, it ensures unmatched
                      accuracy in timekeeping. Each tourbillon is a marvel of
                      engineering, with its intricate design and delicate
                      movement captivating watch enthusiasts worldwide. Limited
                      in production and crafted with the finest materials, the
                      tourbillon is not just a timepiece but a symbol of
                      sophistication and timeless luxury, cherished by
            ...
            <form>
              <div className="row">
                ...
                <div className="col-md-6 col-sm-12">
                  ...
                  <div className="about__data">
                    <p className="about__description">
                      The Bugatti Centodieci is a rare gem, paying homage to the
                      legendary Bugatti EB110. Limited to just 10 units, it
                      boasts a formidable 1,600 horsepower from its
                      quad-turbocharged W16 engine. With design cues reminiscent
                      of its predecessor and contemporary styling, the
                      Centodieci represents the pinnacle of automotive
            ...
            <form>
              <div className="row">
                ...
                <div className="col-md-6 col-sm-12">
                  ...
                  <div className="about__data">
                    <p className="about__description">
                      The Bugatti Chiron epitomizes automotive excellence with
                      its unparalleled combination of speed, power, and luxury.
                      Boasting a quad-turbocharged W16 engine generating 1,500
                      horsepower, it accelerates from 0 to 60 mph in under 2.5
                      seconds. Limited to just 500 units, its sleek design and
                      opulent interior make it a coveted symbol of prestige and

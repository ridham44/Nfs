          ...
          <div class="row">
            <div class="col-xl-6 col-md-6 col-sm-12">
              ...
              <p class="header__description">
                In essence, Koenigsegg is a Swedish manufacturer of
                high-performance sports cars known for their speed, innovation,
                and exclusivity. Founded in 1994 by Christian von Koenigsegg,
                the company produces limited numbers of extremely fast and
                technologically advanced vehicles, making them highly coveted
                ...
                <div className="col-md-6 col-sm-12">
                  ...
                  <div className="about__data">
                    <p className="about__description">
                      The Koenigsegg Jesko is a high-performance hypercar
                      produced by Koenigsegg, named after Jesko von Koenigsegg,
                      the father of the company's founder. It features a
                      powerful twin-turbocharged V8 engine producing over 1,600
                      horsepower, along with advanced aerodynamics and a new
                      9-speed transmission for lightning-fast gear changes. The
                      Jesko represents the pinnacle of automotive engineering
                      and performance from Koenigsegg, with a focus on track
                      performance and road usability.
                    </p>
            ...
            <form>
              <div className="row">
                ...
                <div className="col-md-6 col-sm-12">
                  ...
                  <div className="about__data">
                    <p className="about__description">
                      The Koenigsegg Regera is a revolutionary hypercar
                      featuring a hybrid powertrain that combines a 5.0-liter
                      twin-turbo V8 with three electric motors, delivering 1,500
                      horsepower. Introduced in 2015, it boasts a top speed over
                      250 mph and accelerates from 0 to 60 mph in just 2.8
                      seconds. The Regera's innovative Direct Drive transmission
                      replaces the traditional gearbox, enhancing performance.
                      With a carbon-fiber chassis and active aerodynamics, it’s
                      a rare and luxurious model, limited to 80 units and priced
                      around $2 million.
                    </p>
            ...
            <form>
              <div className="row">
                ...
                <div className="col-md-6 col-sm-12">
                  ...
                  <div className="about__data">
                    <p className="about__description">
                      The Koenigsegg Agera is a hypercar that epitomizes speed
                      and innovation. With a 5.0-liter twin-turbo V8 engine
                      producing 1,160 horsepower, the Agera is capable of
                      reaching an astonishing top speed of 273 mph. Its design
                      blends cutting-edge aerodynamics with lightweight carbon
                      fiber construction, ensuring both exceptional performance
                      and agility. Known for its record-breaking capabilities,
                      the Agera is a masterpiece of engineering that continues
                      to be revered in the world of high-performance vehicles,
                      combining unparalleled power with luxurious craftsmanship.
                    </p>

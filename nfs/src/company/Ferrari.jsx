          ...
          <div class="row">
            <div class="col-xl-6 col-md-6 col-sm-12">
              ...
              <p class="header__description">
                Widely regarded as the maker of the finest supercars of all, not
                least by Ferrari itself. The iconic ‘Cavallino Rampante’ badge
                has adorned some of the finest and most expensive fast cars of
                all time, and also a load of teddies and key-rings in those
                weird airport-departure-lounge shops. Ferrari’s road car
                division is inextricably intertwined with its F1 team, which –
                despite a lean few years – has still bagged more titles than any
                other constructor.
              </p>
            </div>
            ...
            <div class="col-xl-3 col-md-3 col-sm-16">
              <div class="Company__description">
                <ul class="bugatti-list">
                  <li>
                    Founded 13 September 1939; 84 years ago in Modena, Italy (as
                    Auto Avio Costruzioni)[1]
                  </li>
                  <li>Founder: Enzo Ferrari</li>
                  <li>Subsidiaries: Scuderia Ferrari S.p.A.</li>
                  <li>
                    Headquarters: Maranello, Emilia-Romagna, Italy Modena,
              ...
              <div className="row">
                <div className="col-md-6 col-sm-12">
                  ...
                  <div className="about__img-container">
                    <img
                      src={Ferrari_sp3Daytona_img}
                      alt="Ferrari Sp3 Daytona"
                ...
                <div className="col-md-6 col-sm-12">
                  ...
                  <div className="about__data">
                    <p className="about__description">
                      The Ferrari Daytona SP3 is a limited-production hypercar
                      unveiled in 2021 as part of Ferrari's "Icona" series,
                      paying homage to the brand's racing heritage. Inspired by
                      the iconic Ferrari 330 P4, the SP3 features a naturally
                      aspirated 6.5-liter V12 engine producing 829 horsepower,
                      making it one of the most powerful non-hybrid Ferraris
                      ever built. With a top speed of 211 mph and a 0-60 mph
                      time of 2.85 seconds, the SP3 combines cutting-edge
                      performance with classic design elements. Only 599 units
                      are being produced, each priced at around $2.25 million,
            ...
            <form>
              <div className="row">
                ...
                <div className="col-md-6 col-sm-12">
                  ...
                  <div className="about__data">
                    <p className="about__description">
                      The Ferrari 296 GTB is a dynamic fusion of performance and
                      sophistication. With its turbocharged V6 engine and
                      electric motor, it generates over 800 horsepower and
                      achieves 0-60 mph in under 3 seconds. Its sleek design and
                      luxurious interior epitomize Ferrari's legacy of
                      automotive excellence, making the 296 GTB a symbol of
                      unparalleled craftsmanship and innovation.
                    </p>
            ...
            <form>
              <div className="row">
                ...
                <div className="col-md-6 col-sm-12">
                  ...
                  <div className="about__data">
                    <p className="about__description">
                      LaFerrari is Ferrari's flagship model, boasting a hybrid
                      powertrain that churns out 950 horsepower. Its
                      acceleration from 0 to 60 mph in under 3 seconds and top
                      speed exceeding 217 mph make it a true performance marvel.
                      With only 499 units produced, its striking design and
                      cutting-edge technology make LaFerrari an iconic symbol of

        ...
        <Router>
            <main>
                <Routes>
                    ...
                    <Route path="/Centenario" element={<Lamborghini_Centenario />} exact />
                    ...
                    <div id="carouselExampleIndicators" className="carousel slide" data-bs-ride="carousel">
                        ...
                        <div className="carousel-inner">
                            <div className="carousel-item active">
                                <img src={cr1} className="d-block w-100" alt="First slide" style={{ height: '550px', width: '200px' }} />
                            </div>
                            <div className="carousel-item">
                                <img src={cr2} className="d-block w-100" alt="Second slide" style={{ height: '550px', width: '100%' }} />
                            </div>
                            <div className="carousel-item">
                                <img src={cr3} className="d-block w-100" alt="Third slide" style={{ height: '550px', width: '100%' }} />
                            </div>
                            <div className="carousel-item">
                                <img src={cr4} className="d-block w-100" alt="Fourth slide" style={{ height: '550px', width: '100%' }} />
                            </div>
                            <div className="carousel-item">
                                <img src={cr5} className="d-block w-100" alt="Fifth slide" style={{ height: '550px', width: '100%' }} />
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div className="col-md-6 col-sm-12">
                                    ...
                                    <div className="about__data">
                                        ...
                                        <p className="about__description">
                                            The Bugatti Tourbillon is a luxury timepiece that embodies the same precision and craftsmanship
                                            found in Bugatti's hypercars. Designed in collaboration with renowned watchmakers, this watch
                                            features an intricate tourbillon movement, echoing the engineering marvels of Bugatti's
                                            automotive creations. With its bold design and high-end materials, the Bugatti Tourbillon is a
                                            true statement piece for collectors and enthusiasts alike.
                                        </p>
                                ...
                                <div className="swiper-wrapper">
                                    <div className="swiper-slide">
                                        <div className="popular__card">
                                            ...
                                            <img src={bugatti_centodice_img} alt="" className="popular__img" />
                                ...
                                <div className="swiper-wrapper">
                                    <div className="swiper-slide">
                                        <div className="popular__card">
                                            ...
                                            <img src={ferrari_296gtb_img} alt="" className="popular__img" />
                                            <div className="popular__data">
                                ...
                                <div className="swiper-wrapper">
                                    <div className="swiper-slide">
                                        <div className="popular__card">
                                            ...
                                            <img src={lamborghini_revuelto_img} alt="" className="popular__img" />
                                            <div className="popular__data">
                                ...
                                <div className="swiper-wrapper">
                                    <div className="swiper-slide">
                                        <div className="popular__card">
                                            ...
                                            <img src={rollroyce_spectre_img} alt="" className="popular__img" />
                                            <div className="popular__data">
                                                <div className="popular__data-group">2.4 sec</div>
                                ...
                                <div className="row">
                                    <div className="col-md-6 col-sm-12">
                                        <div className="coming__data">
                                            <h2 className="section__title offer__title">Coming Soon!</h2>
                                            <p className="coming__description">
                                                <b>
                                                    "Rev up your excitement! Our F1 addition is about to hit the track, delivering the
                                                    ultimate rush of car information like never before. Get ready to accelerate into the
                                                    future of automotive knowledge."
                                                </b>
                                            </p>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="popular__card">
                                            ...
                                            <img src={bugatti_chiron_img} alt="" class="popular__img" />
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="popular__card">
                                            ...
                                            <img src={lamborghini_centenario_img} alt="" class="popular__img" />
                                            <div class="popular__data">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="popular__card">
                                            ...
                                            <img src={koenigsegg_jesko_img} alt="" class="popular__img" />
                                            <div class="popular__data">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="popular__card">
                                            ...
                                            <img src={ferrari_laferrari_img} alt="" class="popular__img" />
                                            <div class="popular__data">
                                                <div class="popular__data-group">2.4 sec</div>
                                                <div class="popular__data-group">350 Km/h</div>
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="offer__data">
                                        ...
                                        <p class="offer__description">
                                            Be the first to receive all the information about our products and new cars by email by
